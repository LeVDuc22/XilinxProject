...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lab1.autotvin.dat"
	set constFileTvOut       "lab1.autotvout.dat"
	set constFileHdlTvIn     "lab1.autohdltvin.dat"
	set constFileHdlTvOut    "lab1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
